<template>
    <v-container fluid v-if="exam && exam.questions && resolution && resolution.answers">
        <v-row class="justify-center">
            <v-col :style="{ 'min-width': '360px', 'max-width': '960px' }">
                    ...
                    <v-card-text>
                        <v-list flat>
                            <v-list-item-group v-for="question in exam.questions" :key="question._id">
                                <v-list-item>
                                    <v-list-item-content>
                                        <v-list-item-title class="text--darken-2 mb-3 text-wrap"> <strong>{{ question.text
